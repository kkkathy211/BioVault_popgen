...
| [`admixture/`](admixture/) | Estimate ancestry proportions per individual against the 1KGP reference (AFR/EUR/EAS/SAS/AMR), plus local-ancestry inference along the genome. | 1KGP high-coverage |
